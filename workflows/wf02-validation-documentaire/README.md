...
- [`SPEC.functional.md`](SPEC.functional.md) : cible métier, acteurs, cycle de vie.
- [`SPEC.technical.md`](SPEC.technical.md) : exploration QAUI, contrats MCP, cible n8n.

## Fichiers

- [`workflow.json`](workflow.json) : export n8n.
- [`config.env.example`](config.env.example) : variables d’exemple.
