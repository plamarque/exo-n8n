...
| Métrique                                     | Valeur |
| -------------------------------------------- | ------ |
| Fichiers JSON de workflow/snapshots analysés | 8      |
| Nœuds `Code` recensés                        | 25     |
| Somme des lignes `jsCode` (approx.)          | 796    |
| Caractères `jsCode` total                    | 37 542 |


**WF04 (état actuel)** : export complet synchronisé depuis n8n dans [workflow-04-document-enrichment-ai.export.json](../workflows/workflow-04-document-enrichment-ai.export.json) et [workflow-04-document-enrichment-ai.import.json](../workflows/workflow-04-document-enrichment-ai.import.json). Le workflow est passé de plusieurs nœuds Code à **un seul résidu** (`Prepare Category Assignments`).
...
### WF04 — [workflow-04-document-enrichment-ai.import.json](../workflows/workflow-04-document-enrichment-ai.import.json)
