...
3. **Tools**
  - Small automation helpers live under `tools/` (for example `inventory-code-nodes.mjs`, `wf04-push-to-n8n-api.mjs`). Document new scripts in [DEVELOPMENT.md](../DEVELOPMENT.md).
4. **Documentation**
